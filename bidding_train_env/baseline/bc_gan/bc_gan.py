...
# https://www.geeksforgeeks.org/generative-adversarial-network-gan/#architecture-of-gans
class Generator(nn.Module):
    def __init__(self, noise_dim, hidden_dim=64):
        super().__init__()
...
class BCGAN(nn.Module):
    """
        Behavior Cloning with Residual 
        Usage:
        bc = BCR(dim_obs=16)
    ...
    def __init__(self, dim_obs, actor_lr=0.0001, network_random_seed=1, actor_train_iter=30):
        super().__init__()
